...
public class ComponentController {
    ...
    public List<ComponentResponse> list(@Parameter(description = "프로젝트 ID") @PathVariable long projectId, @AuthenticationPrincipal Jwt jwt) {
    ...
    public ComponentResponse create(@Parameter(description = "프로젝트 ID") @PathVariable long projectId, @RequestBody ComponentRequest request, @AuthenticationPrincipal Jwt jwt) {
        return service.create(userId(jwt), projectId, request);
    }

    @Operation(summary = "컴포넌트를 수정한다")
    @PutMapping("/api/alm/components/{id}")
    public ComponentResponse update(@Parameter(description = "컴포넌트 ID") @PathVariable long id, @RequestBody ComponentRequest request, @AuthenticationPrincipal Jwt jwt) {
    ...
    public void delete(@Parameter(description = "컴포넌트 ID") @PathVariable long id, @AuthenticationPrincipal Jwt jwt) {
